...
export function NotePage({ note, onChange, onBack }) {
  ...
  return (
    ...
    <div
      className="milo-on-tint flex h-full flex-col"
      style={{ backgroundColor: noteColour(note.colour).bg }}
    >
      ...
      {/* the editor's root is flex-1, and the pane supplies its side padding */}
