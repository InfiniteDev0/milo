...
export function JournalHero({ hasBooks, onOpen }) {
  return (
    <div className="flex max-w-lg flex-col gap-4">
      ...
      <button
        ...
        className="milo-lift flex w-fit cursor-pointer items-center gap-1.5 rounded-full bg-solid px-5 py-2 text-sm text-solid-ink hover:bg-solid-hover"
      >
